...
class OrdinalWeightedError(nn.Module):
    ...
    def forward(self, input, target):
        ...
        return torch.sum(((input-target_PCNL)**2)*target_weight)/torch.sum(target_weight)
...
import pickle
f = open('reg_PCNL_OWSE_losses.txt', 'wb')
pickle.dump(losses_list, f)
f.close()
f = open('reg_PCNL_OWSE_QWK.txt', 'wb')
pickle.dump(QWK_scores_list, f)
f.close()
f = open('reg_PCNL_OWSE_CEM.txt', 'wb')
pickle.dump(CEM_scores_list, f)
f.close()
f = open('reg_PCNL_OWSE_QWK2.txt', 'wb')
pickle.dump(QWK_scores2_list, f)
f.close()
f = open('reg_PCNL_OWSE_CEM2.txt', 'wb')
pickle.dump(CEM_scores2_list, f)
f.close()
f = open('reg_PCNL_OWSE_QWK3.txt', 'wb')
pickle.dump(QWK_scores3_list, f)
f.close()
f = open('reg_PCNL_OWSE_CEM3.txt', 'wb')
pickle.dump(CEM_scores3_list, f)
f.close()
f = open('reg_PCNL_OWSE_valid_preds.txt', 'wb')
pickle.dump(valid_preds_list, f)
f.close()
f = open('reg_PCNL_OWSE_valid_outputs_PCNL.txt', 'wb')
