...
def trainer(fold, df):
    ...
    criterion = MAE(weight=weight, distribution=distribution)
...
import pickle
f = open('reg_PCNL_MAE_losses.txt', 'wb')
pickle.dump(losses_list, f)
f.close()
f = open('reg_PCNL_MAE_QWK.txt', 'wb')
pickle.dump(QWK_scores_list, f)
f.close()
f = open('reg_PCNL_MAE_CEM.txt', 'wb')
pickle.dump(CEM_scores_list, f)
f.close()
f = open('reg_PCNL_MAE_QWK2.txt', 'wb')
pickle.dump(QWK_scores2_list, f)
f.close()
f = open('reg_PCNL_MAE_CEM2.txt', 'wb')
pickle.dump(CEM_scores2_list, f)
f.close()
f = open('reg_PCNL_MAE_QWK3.txt', 'wb')
pickle.dump(QWK_scores3_list, f)
f.close()
f = open('reg_PCNL_MAE_CEM3.txt', 'wb')
pickle.dump(CEM_scores3_list, f)
f.close()
f = open('reg_PCNL_MAE_valid_preds.txt', 'wb')
pickle.dump(valid_preds_list, f)
f.close()
f = open('reg_PCNL_MAE_valid_outputs_PCNL.txt', 'wb')
